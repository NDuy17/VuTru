...
/**
 * MarsDetails Component
 * @component
 */
const MarsDetails = memo(({ planet, onClose, showExploreButton, isExploreMode, onToggleExplore }) => (
...
MarsDetails.displayName = 'MarsDetails';
MarsDetails.propTypes = {
