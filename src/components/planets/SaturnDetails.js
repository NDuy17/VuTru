...
const SaturnDetails = memo(({ planet, onClose, showExploreButton, isExploreMode, onToggleExplore }) => (
...
SaturnDetails.displayName = 'SaturnDetails';
SaturnDetails.propTypes = {
