...
const JupiterDetails = memo(({ planet, onClose, showExploreButton, isExploreMode, onToggleExplore }) => (
...
JupiterDetails.displayName = 'JupiterDetails';
JupiterDetails.propTypes = {
